          ...
          >
            ...
            <Row :gutter="16">
              <Col span="12">
                ...
                <Col span="12">
                <FormItem label="网站网址" prop="address">
                  <Input v-model="this.datas[0].address"></Input>
                  <p>示例：http://www.yiduhao.com</p>
                </FormItem>       
              </Col>
            </Row>
            <Row :gutter="16">
              ...
              <Col span="12">
                <FormItem label="备注" prop="remark">
                  <Input v-model="this.datas[0].remark"></Input>
                </FormItem>
              </Col>
              </Row>     
              <Row :gutter="16">                    
...
export default {
  ...
  methods: {
    ...
    show(index) {
      this.$Modal.info({
        title: "详情",
        content: `${this.news.title}<br><br>ID：${this.news.id}
                发表时间:${this.news.addtime}阅读量:${this.news.read}<br><br>
                ${this.news.content}`,
      });
    },
    // table表格中的删除按钮
