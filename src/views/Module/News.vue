...
<script>
import { getNews,getItemize,deleteData,UpdateListData } from "../../axios/api.js";
...
export default {
  data() {
    return {
      ...
      modal:false,
      formItem: { id: "", user: "", date1: "", date1: "",showhide:"",title:"" },
      stateModel: "",
      selectList: [], // 多选数据
      selectCount: 0, // 多选计数
      updatelist: [], //表格修改页面数据
