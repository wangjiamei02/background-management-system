                          ...
                          <Row :gutter="16">
                            ...
                            <Col span="12">
                              <FormItem label="预览" prop="look">
                                <a
                                  :href="
                                    `http://localhost/admin-api/api/public/img/` +
                                    this.filename
                                  "
                                  target="_blank"
                                >
          ...
          <div :class="{ modal_body }">
            <Form :model="formTop2" label-position="top" :rules="ruleValidate2">
              ...
              <Row :gutter="16">
                <Col span="12">
                  <FormItem label="手机号" prop="iphone">
                    <Input v-model="this.updatelist.iphone"></Input>
                    <p>示例：13512345678</p>
                  </FormItem>
                </Col>
                <Col span="12">
                  <FormItem label="邮箱" prop="mail">
                    <Input v-model="this.updatelist.mail"></Input>
                    <p>用来找回密码，请认真填写</p>
                  </FormItem>
                </Col>
              </Row>
